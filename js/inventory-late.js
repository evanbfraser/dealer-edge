/* ═══════════════════════════════════════════════════════════════
   INVENTORY PAGE - lazy act choreography
   Generated by splitting js/inventory.js so the hero comparison and
   image observers stay critical while below-fold act handlers load near use.
   ═══════════════════════════════════════════════════════════════ */

window.DE.initInventoryLate = function initInventoryLate(lenis, reduceMotion) {
  'use strict';
  if (window.DE.__inventoryLateInitialized) return;
  window.DE.__inventoryLateInitialized = true;
