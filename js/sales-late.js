/* ═══════════════════════════════════════════════════════════════
   SALES PAGE — lazy act choreography + interactive SMS demo
   Generated by splitting js/sales.js so the opening cohort hero can
   load before below-fold act animation handlers.
   ═══════════════════════════════════════════════════════════════ */

window.DE.initSalesLate = function initSalesLate(lenis) {
  'use strict';
  /* ─────────────────────────────────────────────────────────────
  ...
  // tenant, sends the AI's first text. On the standalone static site there's
