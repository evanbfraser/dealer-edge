...
(() => {
  ...
  const BEAT_ANIMS = {
    'an-late': playLate,
    'an-tabs': playTabs,
    'an-connect': playConnect,
    'an-live': playLive,
    'an-clarity': playClarity,
    'an-funnel': playFunnel,
    'an-vanity': playVanity,
    'an-lag': playLag,
  ...
  /* ═════════════════════════════════════════════════════════════
     ACT 1 · BEAT 2 — seven dashboards that have never met
     ═════════════════════════════════════════════════════════════ */
  ...
  /* ═════════════════════════════════════════════════════════════
     ACT 1 · BEAT 4 — the live report (real screenshot auto-pans)
     ═════════════════════════════════════════════════════════════ */
  function playLive(beatEl, stillCurrent) {
    beatEl.classList.add('is-playing');
    const win = beatEl.querySelector('[data-live-window]');
    const viewport = beatEl.querySelector('[data-live-viewport]');
    const shot = beatEl.querySelector('[data-live-shot]');
    const chip = beatEl.querySelector('[data-live-chip]');
    const meta = beatEl.querySelector('[data-live-meta]');
    if (!win || !shot) return;
