/* ═══════════════════════════════════════════════════════════════
   ANALYTICS PAGE - below-fold act choreography
   Loaded near #one-truth by js/analytics.js.
   ═══════════════════════════════════════════════════════════════ */

(function () {
  'use strict';

  DE.initAnalyticsLate = function initAnalyticsLate(lenis, reduceMotion) {
    if (DE.__analyticsLateInitialized) return;
    DE.__analyticsLateInitialized = true;
