...
**Pricing posture (Jason, 2026-06-16):** default to money **upfront** — the "you don't pay until we beat it" guarantee is a negotiation lever to pull down toward \$0 only if a deal needs it to close, not the opening position.
